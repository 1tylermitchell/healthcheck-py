  *  Work in progress!
  *  healthcheck.py: a simple Python based test script for checking cluster health.  (This approach was abandoned for a Ruby-based serverspec approach - see http://github.com/1tylermitchell/healthcheck)
